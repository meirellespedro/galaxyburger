...
- Configure `DELIVERY_QUOTE_SECRET` com uma chave forte e privada em qualquer ambiente que use a validacao de entrega.
...
- Sem `DELIVERY_QUOTE_SECRET`, a validacao automatica da entrega nao libera pedidos em nenhum ambiente.
