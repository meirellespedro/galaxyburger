...
const adminInventoryHandler = require("../api/admin-inventory");
const inventoryStatusHandler = require("../api/inventory-status");
const orderHandler = require("../api/order-ticket");
